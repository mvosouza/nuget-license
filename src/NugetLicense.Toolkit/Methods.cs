...
namespace NugetLicense.Toolkit
{
    public class Methods
    {
        ...
        private readonly IPackageOptions _packageOptions;
        ...
        public Methods(IPackageOptions packageOptions, HttpClient? httpClient = null)
        {
...
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        public void Output(List<LibraryInfo> libraries) 
        {
            if (_packageOptions.JsonOutput)
            {
                this.SaveAsJson(libraries);
            }
            else if (_packageOptions.MarkDownOutput)
            {
                this.SaveAsMarkdown(libraries);
            }
            else
            {
                this.SaveAsTextFile(libraries);
            }
        }
